...
public class Database {
    ...
    public void addUser(String username, String password){
        ...
        try {
            ...
            Element newusername = doc.createElement("username"); newusername.setTextContent(username.trim());
            Element newpassword = doc.createElement("password"); newpassword.setTextContent(password.trim()   );
